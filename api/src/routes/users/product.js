...
const router = Router();
const { createProduct, createColor,createCategory ,getAllCategories, getAllColors, getAllProducts, createSnack, getSnacks, deleteProduct, deleteSnack,deleteCategory} = require('../../controllers/productControllers/product.Controllers')
