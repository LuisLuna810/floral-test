    ...
    <>
      <Container my={5}>
        ...
        <Box my={4}>
          ...
          <Typography fontFamily={'sans-serif'} p={2} fontSize={".9rem"}>
        ...
        <Box my={4}>
          ...
          <Divider sx={{ borderColor: "#ffc4cc", my: 2 }} />
          <Typography fontFamily={'sans-serif'} p={2} fontSize={".9rem"}>
            Cada pedido es importante para nosotros porque sabemos lo importante que es para usted. Una vez que se realiza un pedido, no
            podemos reembolsarlo, sin embargo, recibirá crédito de la tienda por el monto total pagado. El crédito de su tienda no caduca y
            puede usarlo en cualquier época del año, incluidos los días festivos. Además, si no está completamente satisfecho con la calidad
            de uno de nuestros productos, comuníquese con nosotros de inmediato y tomaremos las medidas adecuadas de inmediato
          </Typography>
        </Box>
      </Container>
      <Footer />
